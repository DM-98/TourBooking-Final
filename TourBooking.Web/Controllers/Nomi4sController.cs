...
public class Nomi4sController : ControllerBase
{
    ...
    public Nomi4sController(ICompanyService companyService, IBookingService bookingService, INomi4sBookingService nomi4sBookingService)
    {
    ...
    [HttpPost("CreateNomi4sBooking"), AllowAnonymous]
    public async Task<ActionResult<ResponseDTO<Nomi4sBooking>>> CreateNomi4sBookingAsync(CreateNomi4sBookingInputModel createNomi4sookingInputModel, CancellationToken cancellationToken)
    {
        ...
        var result = await nomi4sBookingService.CreateNomi4sBookingAsync(createNomi4sookingInputModel, cancellationToken);
        ...
        else
        {
            ...
            else if (result.ErrorType is CreateNomi4sBookingErrorType.CouldNotCreateNomi4sBooking)
            {
